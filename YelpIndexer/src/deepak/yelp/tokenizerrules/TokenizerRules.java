...
public class TokenizerRules {
	...
	public ArrayList<String> applyTokenizationRules(String inputData){
		...
		return stopWords.applyStopWordsRule(specialCharacter.applySpecialCharacterRule(punctuation.applyPunctuationRule(number.applyNumberRule(hyphen.applyHyphenRule(capitalization.applyCapitalizationRule(tokens))))));
	}
